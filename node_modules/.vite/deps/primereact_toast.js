...
} from "./chunk-D5T57WRI.js";
import {
  CheckIcon
} from "./chunk-NZOP4HJB.js";
import {
  Portal
} from "./chunk-Q33GMGHL.js";
import {
  TimesIcon
} from "./chunk-T7GWQJIP.js";
import {
  Ripple
} from "./chunk-YIFWAHN4.js";
import {
  IconBase
} from "./chunk-4BSSKPR2.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
...
var classes = {
  ...
  message: {
    message: function message(_ref2) {
      ...
      return classNames("p-toast-message", _defineProperty2({}, "p-toast-message-".concat(severity), severity));
    },
...
var ToastMessage = React5.memo(React5.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    }, getPTOptions("buttonicon", parentParams), ptmo(pt, "buttonicon", _objectSpread2(_objectSpread2({}, params), {}, {
      hostName: props.hostName
    })));
    ...
    }, getPTOptions("closeButton", parentParams), ptmo(pt, "closeButton", _objectSpread2(_objectSpread2({}, params), {}, {
      hostName: props.hostName
    })));
    if (closable !== false) {
  ...
  var createMessage = function createMessage2() {
    if (messageInfo) {
      ...
      }, getPTOptions("icon", parentParams), ptmo(pt, "icon", _objectSpread2(_objectSpread2({}, params), {}, {
        hostName: props.hostName
      })));
      var icon = _icon;
      if (!_icon) {
      ...
      }, getPTOptions("text", parentParams), ptmo(pt, "text", _objectSpread2(_objectSpread2({}, params), {}, {
        hostName: props.hostName
      })));
      var summaryProps = mergeProps({
        className: cx("message.summary")
      }, getPTOptions("summary", parentParams), ptmo(pt, "summary", _objectSpread2(_objectSpread2({}, params), {}, {
        hostName: props.hostName
      })));
      var detailProps = mergeProps({
        className: cx("message.detail")
      }, getPTOptions("detail", parentParams), ptmo(pt, "detail", _objectSpread2(_objectSpread2({}, params), {}, {
        hostName: props.hostName
      })));
  ...
  var messageProps = mergeProps({
    ...
    onMouseEnter,
    onMouseLeave
  }, getPTOptions("message", parentParams), ptmo(pt, "root", _objectSpread2(_objectSpread2({}, params), {}, {
    hostName: props.hostName
  })));
  var contentProps = mergeProps({
    className: classNames(_contentClassName, cx("message.content")),
    style: contentStyle
  }, getPTOptions("content", parentParams), ptmo(pt, "content", _objectSpread2(_objectSpread2({}, params), {}, {
    hostName: props.hostName
  })));
...
var Toast = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var createElement6 = function createElement7() {
    ...
    return React5.createElement("div", rootProps, React5.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(messageInfo, index) {
      ...
      return React5.createElement(CSSTransition, _extends4({
        nodeRef: messageRef,
